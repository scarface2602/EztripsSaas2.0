...
import { itinerarySchema } from '@/lib/schemas/ai';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { day_number, destination, city, hotel, activities, raw_description, existing_heading, day_type } = itinerarySchema.parse(body);
