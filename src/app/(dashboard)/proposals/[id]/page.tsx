        ...
        <BuilderV2
          ...
          initialData={{
            proposal: {
              ...
              cover_image_url: proposal.cover_image_url ?? null,
              pricing_display_mode: proposal.pricing_display_mode ?? 'per_person',
              inclusions: proposal.inclusions ?? [],
              exclusions: proposal.exclusions ?? [],
              payment_terms_text: proposal.payment_terms_text ?? null,
              terms_conditions: proposal.terms_conditions ?? null,
            ...
            groups: (groups || []).map((g) => ({
              ...
              price_basis: g.price_basis ?? 'total',
            })),
            items: (items || []).map((i) => ({
              ...i,
