...
import type { Proposal, Flight, Supplier } from '@/lib/types/database';
        ...
        <Card key={flight.id}>
          <CardContent className="pt-6 space-y-4">
            <div className="grid grid-cols-4 gap-4">
              ...
              <div className="space-y-2">
                <Label>Baggage</Label>
                <Input value={flight.baggage_allowance || ''} onChange={(e) => updateFlight(index, { baggage_allowance: e.target.value })} />
              </div>
              <div className="space-y-2">
